...
epoch 4:
macro_f1, micro_f1
0.8731646856367458 0.8695286195286195
Accuracy of   OOO : 96 %
Accuracy of   BOO : 92 %
Accuracy of   OLO : 74 %
Accuracy of   BLO : 71 %
...
def train(model_in, num_epochs = 3, load_model = True, freeze_extractor = True):
    ...
    # === got model ===
    save_file = os.path.join('../saved_model', 'CLSTM_18_l10_h512_d02_final.pth')
    writer = SummaryWriter('../saved_model/tensorboard_log_18_l10_h512_d02_final')
    if(load_model == True):
