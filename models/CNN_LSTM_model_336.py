...
import os
import dataloader.VSLdataset_336 as VSLdataset
...
def train(model_in, num_epochs = 3, load_model = True, freeze_extractor = True):
    ...
    # === got model ===
    save_file = os.path.join('../saved_model', 'CLSTM_50_l10_h512_s336.pth')
    writer = SummaryWriter('../saved_model/tensorboard_log_50_l10_h512_s336')
    if(load_model == True):
