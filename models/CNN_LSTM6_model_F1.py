...
F1:
macro_f1, micro_f1
0.8755831184283478 0.9010942760942761
Accuracy of   OOO : 89 %
Accuracy of   BOO : 76 %
Accuracy of   OLO : 94 %
Accuracy of   BLO : 76 %
...
avg_loss:  0.4555613695069997


[8,  2370] loss: 0.411
F1:
macro_f1, micro_f1
0.8687442979619309 0.8935185185185185
Accuracy of   OOO : 90 %
Accuracy of   BOO : 58 %
Accuracy of   OLO : 89 %
Accuracy of   BLO : 88 %
...
def train(model_in, num_epochs = 3, load_model = True, freeze_extractor = True):
    ...
    # === got model ===
    save_file = os.path.join('../saved_model', 'CLSTM_50_l10_h512layer6_d02.pth')
    writer = SummaryWriter('../saved_model/tensorboard_log_50_l10_h512layer6_d02')
    if(load_model == True):
...
if __name__=='__main__':
    #test_model()
    model = CLSTM(lstm_hidden_dim = 512, lstm_num_layers = 6, class_num=8)        
    train(model_in = model, num_epochs = 15, load_model = False, freeze_extractor = False)
