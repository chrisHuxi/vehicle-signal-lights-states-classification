...
def create_dataloader_train_valid_test(train_batch_size=32, valid_batch_size=16, test_batch_size=16):
    ...
    train_dataset, train_sampler = load_dataset(root_dir = '/media/huxi/DATA/inf_master/Semester-5/Thesis/code/SIFT_dataset/train/', class_name_to_id = class_name_to_id_, aug_transform_list = [common_transform_tensor, train_transform])
    

    valid_dataset, valid_sampler = load_dataset(root_dir = '/media/huxi/DATA/inf_master/Semester-5/Thesis/code/SIFT_dataset/valid/', class_name_to_id = class_name_to_id_, aug_transform_list = [common_transform_tensor, None])

    test_dataset, test_sampler = load_dataset(root_dir = '/media/huxi/DATA/inf_master/Semester-5/Thesis/code/SIFT_dataset/test/', class_name_to_id = class_name_to_id_, aug_transform_list = [common_transform_tensor, None])
